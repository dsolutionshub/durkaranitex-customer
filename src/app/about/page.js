    ...
    <main className="max-w-5xl mx-auto px-4 py-12">
      ...
      <section className="mb-12 text-center">
        ...
        <p className="text-lg text-black leading-relaxed">
          For over two decades, we&apos;ve been curating the finest collection of
          authentic Indian sarees from our Salem Elampillai store.
        </p>
      </section>
      ...
      <section className="mb-12 text-center">
        ...
        <div className="p-6 border rounded-lg">
          ...
          <p className="text-black mb-1">Salem Elampillai, Tamil Nadu, India</p>
          <p className="text-gray-700 text-sm">
            Your destination for authentic South Indian silk sarees and handloom
            collections.
          </p>
        </div>
      </section>
      ...
      {/* Our Journey */}
      <section className="mb-12 text-center">
        <h2 className="text-2xl font-semibold text-black mb-6">Our Journey</h2>
      ...
      <section className="mb-12">
        ...
        <p className="text-black leading-relaxed mb-4">
          ...
          with skilled artisans across India to bring you authentic pieces that
          honor traditional craftsmanship.
        </p>
      ...
      <section className="border p-6 rounded-lg">
        ...
        <p className="text-black leading-relaxed">
          We deliver authentic, high-quality sarees that connect you to India&apos;s
          rich cultural heritage. Whether for weddings, parties, or everyday
          elegance, we help you find the perfect piece while supporting
