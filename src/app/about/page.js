...
import { MapPin, Users, Award, Heart, Truck, Star } from "lucide-react"; // 🛠️ Added Truck and Star
...
const About = () => {
      ...
      <main className="max-w-5xl mx-auto px-4 pt-3 pb-5">
       ...
       {/* Our Store */}
        <section className="mb-12">
          <h2 className="text-3xl font-semibold text-black mb-8 text-center">Our Store Location</h2>
  ...
  <div className="text-center">
    <p className="text-black mb-2 text-lg">6/380, Ashok Nagar, Perumagoundampatti,</p>
    <p className="text-black mb-4 text-lg">Salem, Tamil Nadu 637502</p>
    <p className="text-black mb-6">
      Our store featuring the largest collection of designer and traditional sarees,
      with personalized styling consultations and expert guidance from our experienced team.
    </p>
    ...
    <div className="w-full h-64">
      ...
      ></iframe>
        ...
        {/* Success Stories */}
        <section className="mb-12">
          <h2 className="text-3xl font-semibold text-black mb-8 text-center">Our Success Journey</h2>
        ...
        <div className="mb-8">
          ...
          <p className="text-black leading-relaxed mb-6">
            Our mission is to preserve and promote the art of saree weaving while providing modern women with elegant, high-quality sarees for every occasion. We work directly with skilled artisans and weavers across India to bring you authentic pieces that honor traditional techniques.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <h3 className="text-lg font-semibold mb-2" style={{ color: '#C2185B' }}>
  Authentic Quality
</h3>


              <p className="text-black text-sm">Every saree is carefully selected for its quality, authenticity, and craftsmanship.</p>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-1 rounded-lg text-center">
              <Users className="w-8 h-8 text-purple-600 mx-auto mb-3" />
            <h3 className="text-lg font-semibold mb-2" style={{ color: '#6A1B9A' }}>
  Original Handcraft
</h3>

              <p className="text-black text-sm">We partner with skilled weavers and artisans to offer fair trade, handcrafted originals.</p>
            </div>
            <div className="bg-gradient-to-br from-pink-50 to-purple-50 p-1 rounded-lg text-center">
              <Heart className="w-8 h-8 text-pink-600 mx-auto mb-3" />
           <h3 className="text-lg font-semibold mb-2" style={{ color: '#AD1457' }}>
  Curated Collection
</h3>

              <p className="text-black text-sm">Our team carefully curates each piece to offer you the best in traditional and contemporary designs.</p>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-1 rounded-lg text-center">
              <Star className="w-8 h-8 text-purple-600 mx-auto mb-3" />
              <h3 className="text-lg font-semibold mb-2" style={{ color: '#4A148C' }}>
  Customer Care
</h3>

              <p className="text-black text-sm">We provide personalized service to help you find the perfect saree for any occasion.</p>
            </div>
          </div>
        </div>
