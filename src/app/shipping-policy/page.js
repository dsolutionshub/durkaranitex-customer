...
const ShippingPolicy = () => {
    ...
    <>
      ...
      {/* Content  */}
       <main className="p-6 sm:p-8  max-w-7xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-pink-50 rounded-lg">
              ...
              <p className="text-black text-sm">Eco-friendly materials with care instructions</p>
            </div>
            <div className="text-center p-6 bg-purple-50 rounded-lg">
              ...
              <p className="text-black text-sm">Express shipping options available</p>
            </div>
            <div className="text-center p-6 bg-pink-50 rounded-lg">
              <MapPin className="w-12 h-12 text-pink-600 mx-auto mb-3" />
              <h3 className="font-semibold text-black mb-2">Pan India</h3>
              <p className="text-black text-sm">Delivery across all major cities</p>
            </div>
            <div className="text-center p-6 bg-purple-50 rounded-lg">
        ...
        {/* <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Shipping Options & Timeframes</h2>
            ...
            <table className="w-full border-collapse border border-gray-300">
              <thead>
                <tr className="bg-gray-50">
                  ...
                  <th className="border border-gray-300 px-4 py-3 text-left font-semibold">Shipping Cost</th>
                  <th className="border border-gray-300 px-4 py-3 text-left font-semibold">Tracking</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3">₹99 (Free above ₹2,000)</td>
                  <td className="border border-gray-300 px-4 py-3">✓ Available</td>
                </tr>
                <tr className="bg-gray-50">
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3">Within 24 hours</td>
                  <td className="border border-gray-300 px-4 py-3">₹399</td>
                  <td className="border border-gray-300 px-4 py-3">✓ Available</td>
                </tr>
              </tbody>
            </table>
            <p className="text-sm text-gray-600 mt-2">*Same day delivery available in Mumbai, Delhi, Bangalore, and Chennai only</p>
          </div>
        </section> */}

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-black mb-4">Processing Time</h2>
          <div className="bg-yellow-50 p-6 rounded-lg">
            <p className="text-black mb-4">
              <strong>Order Processing:</strong> All orders are processed within 1-2 business days. Orders placed after 2 PM on Friday will be processed on the next Monday.
            </p>
            <ul className="text-black space-y-2">
              <li>• <strong>Ready-to-ship sarees:</strong> 1 business day</li>
              <li>• <strong>Custom alterations:</strong> 3-5 business days</li>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-black mb-4">Delivery Locations</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-green-50 p-6 rounded-lg">
             <h3 className="text-lg font-semibold mb-3" style={{ color: '#C2185B' }}>
  We Deliver To
</h3>
  ...
  Delivery Restrictions
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-black mb-4">Packaging</h2>
          <p className="text-black leading-relaxed mb-4">
            Your sarees are carefully packaged to ensure they arrive in perfect condition:
          </p>
          <ul className="text-black space-y-2">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-black mb-4">Shipping Issues</h2>
          <p className="text-black leading-relaxed mb-4">
