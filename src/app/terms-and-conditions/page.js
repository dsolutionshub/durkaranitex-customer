      ...
      <div className="prose max-w-none">
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg mb-8 border border-green-200">
          ...
          <p className="text-black">
            By using our saree e-commerce website, you agree to these terms and
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md border">
              ...
              <p className="text-black text-sm">
                Receipt of an order number does not constitute acceptance of an
                order. We reserve the right to accept or decline orders for any
                reason.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md border">
        ...
        <section className="mb-10">
          ...
          <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
            ...
            <ul className="text-black space-y-2">
              ...
              <li>
                • Address changes after order confirmation may incur additional
                charges
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-pink-50 p-6 rounded-lg border border-pink-200">
            ...
            <p className="text-black leading-relaxed mb-4">
              Returns and refunds are governed by our Return Policy. Key points
              include:
            </p>
            <ul className="text-black space-y-2">
