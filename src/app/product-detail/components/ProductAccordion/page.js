  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3 items-center">
          <button onClick={handleLike} className="fs-5">
            {isLiked ? (
              <FaHeart color="#cb0a1c" />
            ) : (
              <FaRegHeart color="var(--dark-color)" />
            )}
          </button>

          <IoShareSocialSharp className="dark-color fs-5 cursor-pointer" />
        </div>
      </div>
      ...
      <div className="mt-5 flex flex-col md:flex-row items-center md:items-center space-y-4 md:space-y-0 md:space-x-4 w-full">
        <p className="dark-color mb-0">Quantity:</p>
        <br />
        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-full space-y-3 md:space-y-0 md:space-x-3 gap-3 product-detail-cart-btn">
