...
const items = [{ label: "Replacement Policy" }];
const home = { label: "Home", url: "/" };

const ReturnPolicy = () => {
  return (
    <main className="p-6 sm:p-8 md:p-10 lg:p-12 max-w-7xl mx-auto">
      <BreadCrumb
        model={items}
        home={home}
        className="pb-2 custom-breadcrumb"
      />
      ...
      <div className="prose max-w-none">
        <section className="mb-8">
          ...
          <p className="text-black leading-relaxed mb-4">
            ...
            replacements to ensure your complete satisfaction. Please note that
              ...
              const steps = [
                {
                  ...
                  desc: "Email us at replacements@sareestore.com or call +91 98765 43210 to initiate your replacement request. Please have your order number ready.",
                },
                {
        ...
        <section className="mb-8">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg">
            <ul className="text-gray-700 space-y-2 list-disc pl-5">
              ...
              <li>
                <span className="inline font-bold text-black">Total Time:</span>{" "}
        ...
        <section>
          ...
          <div className="bg-gradient-to-r from-pink-100 to-purple-100 p-6 rounded-lg">
            <p className="text-black leading-relaxed mb-4">
              ...
              needs! We&apos;re committed to ensuring you get the perfect saree.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex items-center">
                <span className="font-semibold text-gray-800">Email:</span>
                <span className="ml-2 text-pink-600">
                  replacements@sareestore.com
                </span>
              </div>
              <div className="flex items-center">
                <span className="font-semibold text-gray-800">Phone:</span>
                <span className="ml-2 text-pink-600">+91 98765 43210</span>
              </div>
            </div>
          </div>
        </section>
