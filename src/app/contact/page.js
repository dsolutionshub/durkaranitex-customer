    ...
    <div className="px-6 py-12 max-w-7xl mx-auto">
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <p className="text-black mb-8 text-base leading-relaxed">
            ...
            sarees, need styling advice, or want to know more about our
      ...
      <div className="mt-16 grid md:grid-cols-3 gap-8">
        ...
        <div className="text-center p-6 bg-white rounded-lg border shadow-sm">
          ...
          <p className="text-black text-sm mb-2">Personalized styling advice</p>
          <p className="text-green-600 font-medium text-sm">+91 98765 43211</p>
        </div>
